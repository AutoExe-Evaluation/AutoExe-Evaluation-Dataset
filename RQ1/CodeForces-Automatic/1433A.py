def main():
    # PRE:
    # Input Format:
    # The first line of the input contains one integer t (1 \le t \le 36) — the number of test cases.The only line of the test case contains one integer x (1 \le x \le 9999) — the apartment number of the resident who answered the call. It is guaranteed that x consists of the same digit.
    # POST:
    # Program Description:
