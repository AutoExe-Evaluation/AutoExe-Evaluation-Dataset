public class ArrayShift {
    public static void move_one_ball(int[] arr) {
        boolean _result;
        if (arr.length == 0) {
            _result = true;
        }
        ...
        System.arraycopy(arr, min_index, my_arr, 0, arr.length - min_index);
        System.arraycopy(arr, 0, my_arr, arr.length - min_index, min_index);
